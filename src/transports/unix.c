...
int xrpc_transport_server_init_unix(
    struct xrpc_transport **s, const struct xrpc_unix_server_config *args) {
  int ret, fd;
...
int xrpc_transport_client_init_unix(
    struct xrpc_transport **s, const struct xrpc_unix_client_config *args) {
